...
public class WizLog {
    ...
    private static String[] IGNORED = new String[] {"java.", "javax.", "jakarta."};
    ...
    public static void info(String message) {
        message = make("INFO", message, null);
        if (WizLog.VERBOSE) {
    ...
    public static void warn(String message) {
        message = make("WARN", message, WizLog.class);
        if (WizLog.VERBOSE) {
            System.out.print(message);
            System.out.flush();
        }
    ...
    public static void erro(Throwable error) {
        var message = make("ERRO", error.getMessage(), error);
        if (WizLog.VERBOSE) {
            System.out.print(message);
            System.out.flush();
        }
    ...
    private static boolean isWatched(StackTraceElement element) {
        if (element.getClassName().equals("br.net.pin.jabx.mage.WizLog")) {
            return false;
        }
